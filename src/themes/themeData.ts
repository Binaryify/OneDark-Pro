export default {
  ...
  editorThemes: {
    ...
    oneDarkPro: () => import('./data/oneDarkPro'),
    oneDarkProFlat: () => import('./data/oneDarkProFlat'),
    oneDarkProDarker: () => import('./data/oneDarkProDarker'),
    panda: () => import('./data/panda'),
    solarized: () => import('./data/solarized'),
    solarizedFlat: () => import('./data/solarizedFlat'),
    shadow: () => import('./data/shadow'),
    vscode: () => import('./data/vscode'),
    justBlack: () => import('./data/justBlack'),
